...
inactive = [109,134,232]
intermediate = [205,284,9]
active = [157,205,7]
...
for i in tqdm(range(1, 201), desc="Processing files"):
    filename = f'/home/kihongk2/MSM_Construction/System3a3b/msm/bt/msm_btsp_56_{i}.pkl'
...
with open('3a3b_mfpt_averages_stddevs.pkl', 'wb') as f:
    pickle.dump(results, f)

print("Averages and standard deviations have been saved to '3a3b_mfpt_averages_stddevs.pkl'")
