...
for i in tqdm(range(1, 201), desc="Processing files"):
    filename = f'/home/kihongk2/MSM_Construction/System82/msm/bt/msm_btsp_56_{i}.pkl'
...
with open('82_mfpt_averages_stddevs.pkl', 'wb') as f:
    pickle.dump(results, f)

print("Averages and standard deviations have been saved to '82_mfpt_averages_stddevs.pkl'")
