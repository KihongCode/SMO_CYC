...
data1 = np.load('Sys1_HMass_Distances.npy')[0]
data2 = np.load('Sys9_HMass_Distances.npy')[0]
...
l[0].savefig("/home/pdb3/kihongk2/Images/TICA_19.png", dpi=300, transparent = True)
